...
public class Controller {
    ...
    void initialize() throws IOException {
        ...
        List<String> strings = Files.readAllLines(Paths.get(selectedFile.getPath()));
    ...
    @FXML
    public void onLoadFromFileClicked(ActionEvent event) throws IOException {
        Text_Field.clear();
        JFileChooser fileChooser = new JFileChooser();
        int openDialog = fileChooser.showOpenDialog(null);
        File selectedFile = fileChooser.getSelectedFile();
    ...
    public void setCanvases(int numCanvases) { // Установливает количество столбцов с холстами для вывода по разрядам (37 столбцов для строк, 10 столбцов для чисел)
        ...
        for (int i = 0; i < numCanvases; ++i) {
            ...
            //label.setPrefWidth(500); //185////////////////////////////////////////////////////
            String stroka = Text_Field.getText();
            //String noPrefixStr = stroka.substring(stroka.indexOf(prefix) + prefix.length());
            ...
            scrollPane.setPrefHeight(scrollPaneLow.getHeight()-50);//////////////////////////////////////////
    ...
    public void onFillingButtonClicked(ActionEvent event) { // Если нажата клавиша "Заполнить"
        ...
        if (strNum.length() != 0) {
            ...
            for (int i = 0; i < count; ++i) {
                Integer num = edgeOt + random.nextInt(edge - edgeOt + 1);
                if (i != count - 1) {
